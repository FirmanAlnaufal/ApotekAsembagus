    ...
    <section class="content">
      ...
      <div class="box">
        <div class="box-header">
            <a href="<?=site_url('obat_keluar/add')?>" class="btn btn-primary btn-social" title="Tambah Data" data-toggle="tooltip">
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td class="text-center" width="160px">
                    <a  href="<?= site_url('obat_keluar/detail/'.$data->id_obt_keluar)?>" class="btn btn-success btn-xs">
