    ...
    <div class="box">
        <div class="box-header">
            <div>
                ...
                <a href="<?= site_url('obat_masukl/print') ?>" class="btn btn-danger btn-social" title="print" data-toggle="tooltip" target="_blank">
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="<?=site_url('obat_masukl/pdf')?>" method="post" target="_blank">
                <table>
                    <tr>
                        <td>
                ...
                <div class="modal-footer">
                    <a href="<?=site_url('obat_masukl/pdff')?>" class="btn btn-primary" target="_blank">cetak semua data</a>
                </div>
            </div>
        </div>
    </div>
